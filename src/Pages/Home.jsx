...
const WORDS = ["Web Developer", "Creative Developer"];
const TECH_STACK = ["React", "Vue.js", "Next.js", "Flutter"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/zoukhdev" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/zoukhdev/" },
  { icon: Instagram, link: "https://www.instagram.com/zoukhdev/" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    ...
    loop: true,
    autoplay: true,
    // rendererSettings removed to fix React warning
